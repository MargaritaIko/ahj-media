...
;// CONCATENATED MODULE: ./src/js/elems/Modal.js
...
;// CONCATENATED MODULE: ./src/js/elems/Timeline.js
...
class Timeline {
  ...
  init() {
    const timelineEl = createElementFromHTML(`<div class="timeline">
        <h1 class="timeline-title">История переписки</h1>
        <ul class="timeline-list"></ul>
        <textarea class="timeline-textarea" placeholder="Type your message here and press Enter"></textarea>            
      </div>`);
